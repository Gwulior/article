...
Целью статьи не является переосмысление проекта и демонстрация идеальной REST архитектуры, статья показывает как устроены основные компоненты Angular 2 и как с минимальными затратами перейти на Angular 2. В любом случае, за любые полезные поправки и замечания буду благодарен, буду стараться оперативно вносить правки.
Итак начнем.
...
###Итого
Мне как человеку не имевшего дела с первым **Angular**o'ом (который на первый взгляд мне не нравился), нет возможности их сравнить. Когда я решал какой из них начинать использовать, решил в пользу второго, прошел через все те изменения которые случились с ним  с беты, переписанный роутер, формы и т.д.
